...
export function ReunionDashboard({
  ...
  const playerIdsKey = useMemo(() => {
    ...
    const groupIds = data.groups.flatMap((group: UserGroup) =>
                          ...
                          >
                            ...
                            <div className='flex gap-1'>
                              <Button
                                ...
                                onClick={() =>
                                  handleRespondToFriend(r._id, 'accepted')
                                }
                              >
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  handleRespondToFriend(r._id, 'rejected')
                                }
                              >
                  ...
                  <div className='space-y-3'>
                    ...
                    <ScrollArea className='h-[200px] rounded-lg border border-border/50 p-2'>
                      <div className='grid gap-2'>
                        {[
                          ...bench.players,
                          ...groups.flatMap((g: UserGroup) => g.members),
                        ]
                          .filter(
                            (p: Player, i, self) =>
                              ...
                              >
                                ...
                                {status === 'accepted' ? (
                                  ...
                                  <Button
                                    ...
                                    onClick={() =>
                                      handleAddFriend(p._id, p.username)
                                    }
                                  >
                                    Add Friend
                                  </Button>
