        ...
        <div className="z-10 flex flex-col items-center w-full max-w-4xl space-y-12">
            ...
            <SignedOut>
                <div className="flex gap-4">
                    <SignInButton>
                        <Button size="lg" className="text-lg px-8 cursor-pointer">Sign In</Button>
                    </SignInButton>
                    <SignUpButton>
                        <Button variant="secondary" size="lg" className="text-lg px-8 cursor-pointer">Start Now</Button>
                    </SignUpButton>
                </div>
            </SignedOut>
            ...
            <SignedIn>
                <div className="grid gap-8 lg:grid-cols-3 w-full animate-in slide-in-from-bottom-10 fade-in duration-700">
                 ...
                 <p className="text-sm text-muted-foreground">Logged in as {user?.firstName || user?.username}</p>
            </SignedIn>
        </div>
     </div>
  )
